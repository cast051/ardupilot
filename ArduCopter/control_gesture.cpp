...
// gesture_run - runs the gesture controller
// should be called at 100hz or more
void Copter::gesture_run()
{
    ...
    if (!failsafe.radio) {
        ...
        wp_nav->set_pilot_desired_acceleration(g.gesture_target_roll, g.gesture_target_pitch);//imark-roll-pitch
